...
-- Grant SELECT permissions on tables to current role (needed for Cortex Search Service)
GRANT SELECT ON TABLE INCIDENTS TO ROLE SF_INTELLIGENCE_DEMO;
GRANT SELECT ON TABLE ENGINEERING_DOCS TO ROLE SF_INTELLIGENCE_DEMO;
GRANT SELECT ON TABLE SERVICES TO ROLE SF_INTELLIGENCE_DEMO;
